...
setup(
    ...
    entry_points={
        ...
        'lim': [
            ...
            'people add = lim.people.add:PeopleAdd',
            'people help = lim.people.help:PeopleHelp',
            'people list = lim.people.list:PeopleList',
            'people remove = lim.people.remove:PeopleRemove',
            'people show = lim.people.show:PeopleShow',
            'people update = lim.people.update:PeopleUpdate',
