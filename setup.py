...
setup(
    ...
    entry_points={
        ...
        'lim': [
            ...
            'cafe docker build = lim.packet_cafe.extensions.docker:ImagesBuild',  # noqa
            'cafe docker down = lim.packet_cafe.extensions.docker:ContainersDown',  # noqa
            'cafe docker images = lim.packet_cafe.extensions.docker:ImagesList',  # noqa
            'cafe docker pull = lim.packet_cafe.extensions.docker:ImagesPull',  # noqa
            'cafe docker ps = lim.packet_cafe.extensions.docker:ContainersList',  # noqa
            'cafe docker up = lim.packet_cafe.extensions.docker:ContainersUp',  # noqa
