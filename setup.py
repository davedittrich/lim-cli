...
setup(
    ...
    entry_points={
        ...
        'lim': [
            ...
            'cafe docker build = lim.packet_cafe.extensions.containers:ImagesBuild',  # noqa
            'cafe docker down = lim.packet_cafe.extensions.containers:ContainersDown',  # noqa
            'cafe docker images = lim.packet_cafe.extensions.containers:ImagesList',  # noqa
            'cafe docker pull = lim.packet_cafe.extensions.containers:ImagesPull',  # noqa
            'cafe docker ps = lim.packet_cafe.extensions.containers:ContainersList',  # noqa
            'cafe docker up = lim.packet_cafe.extensions.containers:ContainersUp',  # noqa
